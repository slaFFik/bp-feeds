...
if ( class_exists( 'BP_Group_Extension' ) ) :
	...
	class BPRF_Groups extends BP_Group_Extension {
		...
		/**
		 * Save the settings in group admin area on front-end
		 *
		 * @param null $group_id
		 */
		...
		/**
		 * Used instead of settings_screen() in the context of group creation.
		 *
		 * @param null $group_id
		 */
		...
		/**
		 * Used instead of settings_screen_save() in the context of group creation.
		 *
		 * @param null $group_id
		 */
